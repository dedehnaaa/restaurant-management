                                            ...
                                            <table class="table align-middle mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-center" colspan="5">Aksi</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                              <?php
                                              ...
                                              ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <i class="fas fa-edit" title="Edit" href="edit.php?id_menu=<?= $m["id_menu"]; ?>"></i>
                                                        </td>
                                                        <td>
                                                          <a href="#" onClick="hapus_item(this.id)" id="<?php echo $row["id_menu"]; ?>" 
...
$("document").ready(function(){
  ...
  $("#tombol_lanjut").click(function(){
   ...
   $("#tombol_tambah_menu").click(function(){
     document.getElementById("fmeja").reset();
     $("#modal_meja").modal("show");
        var el = document.getElementById('nomeja');
        var no = el.options[el.selectedIndex].innerHTML;
