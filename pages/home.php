                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="text-center">Selamat datang di Aplikasi <br />Restoran SMK</h3>
                                        <p class="card-title-desc text-center">Restoran SMK menyediakan makanan dan minuman yang dapat membuat ada semangat 
